            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {{$users->links()}}
                            <table id="myTable" class="table table-bordered table-hover table-left" >
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('users.update', $user->id)}}" method="POST">
                                                        ...
                                                        {{-- <div class="form-floating mb-3">
                                                            <input type="password" class="form-control" id="floatingInput" name="passowrd" value="{{$user->password}}" placeholder="Password" readonly>
                                                            <label for="floatingInput">Password</label>
                                                        </div> --}}
                                                        {{-- <div class="form-floating mb-3">
                                                            <input type="password" class="form-control" id="floatingInput" name="confirm_password" placeholder="Confirm Password" required>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('users.store')}}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="floatingInput" name="email" placeholder="example@gmail.com" required>
                            <label for="floatingInput">Email Address</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="phone" placeholder="1122333" required>
                            <label for="floatingInput">Phone</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" id="floatingInput" name="passowrd" placeholder="Password" required>
                            <label for="floatingInput">Password</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" id="floatingInput" name="confirm_password" placeholder="Confirm Password" required>
