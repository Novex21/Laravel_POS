 <!-- side navigation-->
    ...
    <li class="nav-item  m-0 {{ Route::currentRouteName() === 'home' ? 'active' : '' }}">
        <a href={{ route('home')}} class="nav-link mb-1 " aria-current="page">
            <i class=" fa-fw fa-solid fa-chart-line fa-xl me-3"></i>
            <span class=" d-none d-md-inline ">Dashboard</span>
        </a>
    </li>
    <li class="nav-item m-0 {{ Route::currentRouteName() === 'users.index' ? 'active' : '' }}">
    ...
    <li class="nav-item m-0 {{ Route::currentRouteName() === 'products.index' ? 'active' : '' }}">
    ...
    <li class="nav-item m-0 {{ Route::currentRouteName() === 'transactions.index' ? 'active' : '' }}">
    ...
    <li class="nav-item m-0 {{ Route::currentRouteName() === 'orders.index' ? 'active' : '' }}">
